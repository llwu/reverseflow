...
import numpy as np
from rf.optim import minimize_error
...
inverses = rf.defaults.default_inverses
inverses['Sin'] = rf.inv_ops.inv_math_ops.injsin
inverses['Cos'] = rf.inv_ops.inv_math_ops.injcos

print(inverses  )
inv_g, inputs, out_map = rf.invert.invert((r11,), inverses=inverses)
